<template>
  <div>
    <pageBanner title="TEMPERATURE MONITORING" subtitle="Real-time location systems (RTLS) such as AiRISTA Flow’s solutions provide visibility into the location, status, and movement of equipment, personnel, and patients enterprise-wide." image="url('/temperature-banner.jpg')"></pageBanner>
        ...
        <div class="page-content-inner container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6 page-content-img">
                    <img src="@/assets/img/temperature1.jpg" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
...
<section class="page-content temperature temperature--2">
    <div class="page-content-item bg-grey page-2-col">
        <div class="page-content-inner container">
            <div class="row">
                <div class="col-md-12 col-lg-6 page-content-img">
                    <img src="@/assets/img/temperature2.jpg" alt="" class="img-fluid">
                </div>
                <div class="col-md-12 col-lg-6 page-content-text">
