                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                                ...
                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info1" name="info[]" value="Lone Worker system">
                                                    <label class="form-check-label" for="info1">Lone Worker system</label>
                                                </div>
                                                
                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info2" name="info[]" value="Duress System">
                                                    <label class="form-check-label" for="info2">Duress System</label>
                                                </div>
            
                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info3" name="info[]" value="Satellite Tracking">
                                                    <label class="form-check-label" for="info3">Satellite Tracking</label>
                                                </div>
            
                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info4" name="info[]" value="Vehicle Tracking">
                                                    <label class="form-check-label" for="info4">Vehicle Tracking</label>
                                                </div>
            
                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info5" name="info[]" value="Asset Tracking">
                                        ...
                                        <div class="col-md-4">
                                                ...
                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info6" name="info[]" value="Wireless Coverage Solutions">
                                                    <label class="form-check-label" for="info6">Wireless Coverage Solutions</label>
                                                </div>

                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info7" name="info[]" value="Location or Tracking">
                                                    <label class="form-check-label" for="info7">Location or Tracking</label>
                                                </div>

                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info8" name="info[]" value="Repair/Maintenance">
                                                    <label class="form-check-label" for="info8">Repair/Maintenance</label>
                                                </div>

                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info9" name="info[]" value="Public Wi-Fi">
                                                    <label class="form-check-label" for="info9">Public Wi-Fi</label>
                                                </div>

                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info10" name="info[]" value="General Information">
                                        ...
                                        <div class="col-md-4">
                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info11" name="info[]" value="Safety and Security Solutions">
                                                    <label class="form-check-label" for="info11">Safety and Security Solutions</label>
                                                </div>

                                                <div class="form-check form-check">
                                                    <input class="form-check-input" type="checkbox" id="info12" name="info[]" value="Temperature and Humidity Monitoring">
                                ...
                                <div class="form-group">
                                    <p>
                                        <label for="subject"><strong>Subject:</strong></label>
                                            ...
                                            <div class="form-check form-check">
                                                <input class="form-check-input" type="radio" id="sub6" name="subject" value="Suggestion">
                                                <label class="form-check-label" for="sub6">Suggestion</label>
                                            </div>

                                            <div class="form-check form-check">
                                                <input class="form-check-input" type="radio" id="sub7" name="subject" value="Feedback">
                                                <label class="form-check-label" for="sub7">Feedback</label>
                                            </div>

                                            <div class="form-check form-check">
                                                <input class="form-check-input" type="radio" id="sub8" name="subject" value="Ask information">
                                                <label class="form-check-label" for="sub8">Ask information</label>
                                            </div>

                                            <div class="form-check form-check">
                                                <input class="form-check-input" type="radio" id="sub9" name="subject" value="Pricing info">
                                                <label class="form-check-label" for="sub9">Pricing info</label>
                                            </div>

                                            <div class="form-check form-check">
                                                <input class="form-check-input" type="radio" id="sub10" name="subject" value="Quote">
                                                <label class="form-check-label" for="sub10">Quote</label>
                                            </div>

                                            <div class="form-check form-check">
                                                <input class="form-check-input" type="radio" id="sub11" name="subject" value="Quote" checked>
